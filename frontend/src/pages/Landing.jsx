    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-100">
                <div className="animate-fade-in-up max-w-8xl mx-auto px-4 sm:px-6 lg:px-30 bg-white/90 backdrop-blur-sm shadow-md">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="animate-fade-in-up bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ">
                            <div className="text-4xl mb-4">📍</div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Live Tracker</h3>
                            <p className="text-gray-600 leading-relaxed">Real-time location tracking of buses and metros with accurate arrival times</p>
                        </div>
                        <div className="animate-fade-in-up bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ">
                            <div className="text-4xl mb-4">🗺️</div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Route Finder</h3>
                            <p className="text-gray-600 leading-relaxed">Find the best routes between any two stops with multiple transport options</p>
                        </div>
                        <div className="animate-fade-in-up bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ">
                            <div className="text-4xl mb-4">⏰</div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Real-time Schedules</h3>
                            <p className="text-gray-600 leading-relaxed">Updated schedules and timetables for all public transport services</p>
                        </div>
                    </div>
                </div>
                <div className="max-w-4xl sm:px-6 lg:px-8 py-16 mx-auto text-center">
                    <h2 className="animate-fade-in-up text-4xl font-bold text-gray-900 mb-8">About Ahmedabad Transport</h2>
                    <p className="animate-fade-in-up text-lg text-gray-600 leading-relaxed">
